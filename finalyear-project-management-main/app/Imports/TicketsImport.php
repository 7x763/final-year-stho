...
class TicketsImport implements SkipsOnError, SkipsOnFailure, ToModel, WithHeadingRow, WithValidation
{
    ...
    public function model(array $row)
    {
        ...
        // Create ticket
        // Optimasi: Manual instantiate ticket agar bisa set relationship project
        $ticket = new Ticket([
        ...
        // Set relation project để tránh query DB trong boot()
        $ticket->setRelation('project', $this->project);
        $ticket->save();
